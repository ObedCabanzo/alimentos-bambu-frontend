...
export const MenuPage = ({className, setActive}: {className? : string, setActive: (value: boolean) => void;}) => {
  return (
    <div className={" absolute top-0 right-0 w-[100vw] h-[100vh] bg-black bg-opacity-90 flex flex-col justify-center items-center z-10 transition-all text-white gap-2 ".concat(className ? className : "menu-page--default")}>
